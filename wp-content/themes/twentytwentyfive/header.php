...
<link href="https://fonts.googleapis.com/css2?family=Kanit:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=Oswald:wght@200..700&family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/assets/css/styles.css?ver=<?= rand(100, 999)?>"/>
</head>
<body>
    <header class="header">
        <!-- Phần bên trái -->
        <div class="header-left">
            <img src="http://localhost/movemax/wp-content/uploads/2024/11/logo.png" alt="Logo" class="logo">
            <nav class="nav-menu">
                <a href="#shoes">Loại giày</a>
                <a href="#gender">Giới tính</a>
                <a href="#brand">Thương hiệu</a>
                <a href="#products">Hàng hoá</a>
            </nav>
        </div>
